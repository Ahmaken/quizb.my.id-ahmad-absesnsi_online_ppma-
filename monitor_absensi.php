...
// QUERY ABSENSI PER JADWAL

// Query untuk mendapatkan semua jadwal Madin hari ini
$sql_madin = "SELECT 
                jm.jadwal_id,
                jm.mata_pelajaran,
                jm.jam_mulai,
            ...
            LEFT JOIN absensi_guru ag ON (ag.jadwal_madin_id = jm.jadwal_id AND ag.tanggal = ?)
            WHERE jm.hari = ?
...
<body>
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2><i class="bi bi-clock-history me-1"></i> Monitor Absensi Otomatis</h2>
        </div>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-4" id="mainTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="harian-tab" data-bs-toggle="tab" 
                                data-bs-target="#harian-pane" type="button" role="tab" 
                                aria-controls="harian-pane" aria-selected="true">
                            <i class="bi bi-list-check me-1"></i> Absensi Per Guru
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="per-jadwal-tab" data-bs-toggle="tab" 
                                data-bs-target="#per-jadwal-pane" type="button" role="tab" 
                                aria-controls="per-jadwal-pane" aria-selected="false">
                            <i class="bi bi-calendar-check me-1"></i> Absensi Per Jadwal
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="mainTabContent">
                    <!-- Tab Absensi Harian -->
                    <div class="tab-pane fade show active" id="harian-pane" role="tabpanel" 
                    ...
                    <div class="tab-pane fade" id="per-jadwal-pane" role="tabpanel" 
